...
/**
 * Gaming-mode preferences, reachable from the same root settings screen
 ...
 * settings of its own: the shared GamingSettingsCatalog
 ...
 * The exact same catalog Gaming's own in-shell settings section
 ...
 */
public final class SettingsGamingFragment : AbstractSettingsFragment() {
    ...
    override fun getPreferenceTitle(): Int = R.string.pref_category_gaming_title

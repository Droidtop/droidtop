...
// Generated by wayland-scanner at build time from vendor/wlroots/protocol and
// vendor/wayland-protocols — see ../CMakeLists.txt. Not present until that
// codegen step has actually been run with wayland-scanner on the PATH.
